...
const TodoNew = ({ tasks, handleUpdate, handleDelete, handleNext }) => {
  return (
    <div className="flex flex-col gap-8 h-[50vh] lg:h-full px-2">
      <h3 className="text-center font-semibold text-xl border-b-2 border-blue-400 w-max mx-auto pt-2">
        To-Do Task
      </h3>
